...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_custom_block_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_custom_block_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact', 'NOLidoHero');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_custom_block_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_custom_block_links_link_appearance" AS ENUM('default', 'outline');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact', 'NOLidoHero');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_performance_videos_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__performance_videos_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_custom_block_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_custom_block_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_custom_block_links_link_appearance" DEFAULT 'default'
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_custom_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_custom_block_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_custom_block_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_custom_block_links_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_custom_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "performance_videos_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE IF NOT EXISTS "performance_videos" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_performance_videos_status" DEFAULT 'draft'
  );
  
  CREATE TABLE IF NOT EXISTS "performance_videos_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_performance_videos_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "_performance_videos_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_performer" varchar,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__performance_videos_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  CREATE TABLE IF NOT EXISTS "_performance_videos_v_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_custom_block_links" ADD CONSTRAINT "pages_blocks_custom_block_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_custom_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_custom_block_links" ADD CONSTRAINT "_pages_v_blocks_custom_block_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_custom_block"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "performance_videos_populated_authors" ADD CONSTRAINT "performance_videos_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."performance_videos"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "performance_videos" ADD CONSTRAINT "performance_videos_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "performance_videos" ADD CONSTRAINT "performance_videos_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "performance_videos_rels" ADD CONSTRAINT "performance_videos_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."performance_videos"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "performance_videos_rels" ADD CONSTRAINT "performance_videos_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "performance_videos_rels" ADD CONSTRAINT "performance_videos_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "performance_videos_rels" ADD CONSTRAINT "performance_videos_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v_version_populated_authors" ADD CONSTRAINT "_performance_videos_v_version_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_performance_videos_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v" ADD CONSTRAINT "_performance_videos_v_parent_id_performance_videos_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."performance_videos"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v" ADD CONSTRAINT "_performance_videos_v_version_hero_image_id_media_id_fk" FOREIGN KEY ("version_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v" ADD CONSTRAINT "_performance_videos_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v_rels" ADD CONSTRAINT "_performance_videos_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_performance_videos_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v_rels" ADD CONSTRAINT "_performance_videos_v_rels_posts_fk" FOREIGN KEY ("posts_id") REFERENCES "public"."posts"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v_rels" ADD CONSTRAINT "_performance_videos_v_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_performance_videos_v_rels" ADD CONSTRAINT "_performance_videos_v_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "ticket_types" ADD CONSTRAINT "ticket_types_showcase_id_showcases_id_fk" FOREIGN KEY ("showcase_id") REFERENCES "public"."showcases"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "ticket_types" ADD CONSTRAINT "ticket_types_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_performance_videos_fk" FOREIGN KEY ("performance_videos_id") REFERENCES "public"."performance_videos"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "payload_preferences_rels" ADD CONSTRAINT "payload_preferences_rels_performers_fk" FOREIGN KEY ("performers_id") REFERENCES "public"."performers"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "payload_preferences_rels" ADD CONSTRAINT "payload_preferences_rels_attendees_fk" FOREIGN KEY ("attendees_id") REFERENCES "public"."attendees"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_custom_block_links_order_idx" ON "pages_blocks_custom_block_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_custom_block_links_parent_id_idx" ON "pages_blocks_custom_block_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_custom_block_order_idx" ON "pages_blocks_custom_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_custom_block_parent_id_idx" ON "pages_blocks_custom_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_custom_block_path_idx" ON "pages_blocks_custom_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_custom_block_links_order_idx" ON "_pages_v_blocks_custom_block_links" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_custom_block_links_parent_id_idx" ON "_pages_v_blocks_custom_block_links" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_custom_block_order_idx" ON "_pages_v_blocks_custom_block" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_custom_block_parent_id_idx" ON "_pages_v_blocks_custom_block" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_custom_block_path_idx" ON "_pages_v_blocks_custom_block" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "performance_videos_populated_authors_order_idx" ON "performance_videos_populated_authors" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "performance_videos_populated_authors_parent_id_idx" ON "performance_videos_populated_authors" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "performance_videos_hero_image_idx" ON "performance_videos" USING btree ("hero_image_id");
  CREATE INDEX IF NOT EXISTS "performance_videos_meta_meta_image_idx" ON "performance_videos" USING btree ("meta_image_id");
  CREATE INDEX IF NOT EXISTS "performance_videos_slug_idx" ON "performance_videos" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "performance_videos_updated_at_idx" ON "performance_videos" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "performance_videos_created_at_idx" ON "performance_videos" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "performance_videos__status_idx" ON "performance_videos" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "performance_videos_rels_order_idx" ON "performance_videos_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "performance_videos_rels_parent_idx" ON "performance_videos_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "performance_videos_rels_path_idx" ON "performance_videos_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "performance_videos_rels_posts_id_idx" ON "performance_videos_rels" USING btree ("posts_id");
  CREATE INDEX IF NOT EXISTS "performance_videos_rels_categories_id_idx" ON "performance_videos_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "performance_videos_rels_users_id_idx" ON "performance_videos_rels" USING btree ("users_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_populated_authors_order_idx" ON "_performance_videos_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_populated_authors_parent_id_idx" ON "_performance_videos_v_version_populated_authors" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_parent_idx" ON "_performance_videos_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_version_hero_image_idx" ON "_performance_videos_v" USING btree ("version_hero_image_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_meta_version_meta_image_idx" ON "_performance_videos_v" USING btree ("version_meta_image_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_version_slug_idx" ON "_performance_videos_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_version_updated_at_idx" ON "_performance_videos_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_version_created_at_idx" ON "_performance_videos_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_version_version__status_idx" ON "_performance_videos_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_created_at_idx" ON "_performance_videos_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_updated_at_idx" ON "_performance_videos_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_latest_idx" ON "_performance_videos_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_autosave_idx" ON "_performance_videos_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_rels_order_idx" ON "_performance_videos_v_rels" USING btree ("order");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_rels_parent_idx" ON "_performance_videos_v_rels" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_rels_path_idx" ON "_performance_videos_v_rels" USING btree ("path");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_rels_posts_id_idx" ON "_performance_videos_v_rels" USING btree ("posts_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_rels_categories_id_idx" ON "_performance_videos_v_rels" USING btree ("categories_id");
  CREATE INDEX IF NOT EXISTS "_performance_videos_v_rels_users_id_idx" ON "_performance_videos_v_rels" USING btree ("users_id");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "performers_email_idx" ON "performers" USING btree ("email");
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "attendees_email_idx" ON "attendees" USING btree ("email");
  CREATE INDEX IF NOT EXISTS "ticket_types_showcase_idx" ON "ticket_types" USING btree ("showcase_id");
  CREATE INDEX IF NOT EXISTS "ticket_types_image_idx" ON "ticket_types" USING btree ("image_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_performance_videos_id_idx" ON "payload_locked_documents_rels" USING btree ("performance_videos_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_preferences_rels_performers_id_idx" ON "payload_preferences_rels" USING btree ("performers_id");
  CREATE INDEX IF NOT EXISTS "payload_preferences_rels_attendees_id_idx" ON "payload_preferences_rels" USING btree ("attendees_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_custom_block_links" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_custom_block_links" CASCADE;
  ...
  DROP TABLE "performance_videos_populated_authors" CASCADE;
  DROP TABLE "performance_videos" CASCADE;
  DROP TABLE "performance_videos_rels" CASCADE;
  DROP TABLE "_performance_videos_v_version_populated_authors" CASCADE;
  DROP TABLE "_performance_videos_v" CASCADE;
  DROP TABLE "_performance_videos_v_rels" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_custom_block_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_custom_block_links_link_appearance";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_custom_block_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_custom_block_links_link_appearance";
  ...
  DROP TYPE "public"."enum_performance_videos_status";
  DROP TYPE "public"."enum__performance_videos_v_version_status";
